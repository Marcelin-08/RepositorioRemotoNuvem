...
git config --global user.name "Marcelin-08"
git config --global user.email "marcelo.quaresma011@gmail.com"

:: Adiciona o repositório remoto (só executa se já não estiver adicionado)
git remote get-url origin >nul 2>&1
if errorlevel 1 (
    git remote add origin "https://github.com/Marcelin-08/RepositorioRemotoNuvem.git"
)
